package org.mushikago.tombo.samples;

import org.mushikago.tombo.TomboClient;
...
public class TomboApiSample {
	...
	public String captureSample() throws CaptureException {
	...
	public void deleteSample(String id) throws DeleteException {
	...
	public void infoSample() throws InfoException {
