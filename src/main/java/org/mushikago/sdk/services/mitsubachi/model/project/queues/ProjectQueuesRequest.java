...
/**
 * プロジェクトQueuesのリクエスト。<br>
 * @author miningbrownie
 *
 */
public class ProjectQueuesRequest extends MitsubachiRequest {
	
	/**
	 * リクエスト先のパス。<br>
	 */
	public static final String URI_PATH = "/1/mitsubachi/project/queues";
	...
	/**
	 * ProjectQueuesRequestを構築します。<br>
	 */
	public ProjectQueuesRequest() {}
	
	/**
	 * 指定されたプロジェクト名を使用して、ProjectQueuesRequestを構築します。<br>
	 * @param projectName プロジェクト名
	 */
	public ProjectQueuesRequest(String projectName) {
	 ...
	 * HttpRequestBaseの作成に失敗した場合、又は以下の必須パラメータを指定していない場合、ProjectQueuesExceptionが送出されます。<br>
	 * ・projectName<br>
