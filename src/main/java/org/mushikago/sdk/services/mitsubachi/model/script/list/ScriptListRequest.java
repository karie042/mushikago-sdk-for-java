 ...
 *
 */
public class ScriptListRequest extends MitsubachiRequest {
	
	/**
	 * リクエスト先のパス。<br>
	 */
	public static final String URI_PATH = "/1/mitsubachi/script/list";
	...
	/**
	 * 指定されたプロジェクト名を使用して、ScriptListRequestを構築します。<br>
	 * @param projectName
	 */
	public ScriptListRequest(String projectName) {
	 ...
	 * HttpRequestBaseの作成に失敗した場合、又は以下の必須パラメータを指定していない場合、ScriptListExceptionが送出されます。<br>
	 * ・projectName<br>
