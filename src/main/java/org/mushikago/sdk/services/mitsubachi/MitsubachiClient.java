...
public class MitsubachiClient extends MushikagoClient {
  ...
  protected void checkResponse(JSONObject json) throws APICallException {
    ...
    try {
      ...
      case 561:
        throw new UnknownParameterException(json);
      case 562:
        throw new InvalidParameterValueException(json);
      case 563:
        throw new ProjectNotFoundException(json);
      case 564:
        throw new FileNotFoundException(json);
      case 565:
        throw new ProjectAlreadyExistsException(json);
      }
    }
   ...
   *           パラメータの指定等がおかしい場合
   */
  public HttpFetchResponse httpFetch(HttpFetchRequest request)
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ProjectUpdateResponse projectUpdate(ProjectUpdateRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ProjectInfoResponse projectInfo(ProjectInfoRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ProjectDiscontinueResponse projectDiscontinue(ProjectDiscontinueRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ProjectQueuesResponse projectQueues(ProjectQueuesRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ResourceDeleteResponse resourceDelete(ResourceDeleteRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ResourceStoreResponse resourceStore(ResourceStoreRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ScriptListResponse scriptList(ScriptListRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ScriptDeleteResponse scriptDelete(ScriptDeleteRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ScriptDeployResponse scriptDeploy(ScriptDeployRequest request)
      throws RequestException, BrokerException, APICallException {
   ...
   *           パラメータの指定等がおかしい場合
   */
  public ScriptGetResponse scriptGet(ScriptGetRequest request)
      throws RequestException, BrokerException, APICallException {
