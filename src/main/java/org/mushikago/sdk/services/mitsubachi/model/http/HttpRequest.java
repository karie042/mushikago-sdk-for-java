...
public abstract class HttpRequest extends MitsubachiRequest {
	 ...
	 */
	protected final List<KeyValuePair> entityParameters; // Entity
															// Bodyの「application/x-www-form-urlencoded」書式で送られるパラメータ
	...
	protected boolean checkCharacterCode(String encoding) {
		try {
			(new String("0123456789abcdef")).getBytes(encoding);
			return true;
